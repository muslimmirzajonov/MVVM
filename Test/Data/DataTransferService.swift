...
public protocol DataTransferService {
    ...
    @discardableResult
    func requestUploadFile<T: Decodable, E: ResponseRequestable>(with endpoint: E,
                                                       completion: @escaping CompletionHandler<T>) -> NetworkCancellable? where E.Response == T
...
extension DefaultDataTransferService: DataTransferService {
    public func requestUploadFile<T, E>(with endpoint: E, completion: @escaping CompletionHandler<T>) -> NetworkCancellable? where T : Decodable, T == E.Response, E : ResponseRequestable {
        return self.networkService.requestUploadFile(endpoint: endpoint) { result in
            switch result {
